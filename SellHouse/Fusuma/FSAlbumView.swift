...
final class FSAlbumView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, PHPhotoLibraryChangeObserver, UIGestureRecognizerDelegate {
    ...
    func initialize() {
        ...
        collectionViewConstraintHeight.constant = self.frame.height - imageCropView.frame.height - imageCropViewOriginalConstraintTop - 2
    ...
    func panned(_ sender: UITapGestureRecognizer) {
        ...
        if sender.state == UIGestureRecognizerState.began {
            ...
            if dragDirection == Direction.up && currentPos.y < cropBottomY - dragDiff {
                ...
                collectionViewConstraintHeight.constant = min(self.frame.height - imageCropViewMinimalVisibleHeight, self.frame.height - imageCropViewConstraintTop.constant - imageCropViewContainer.frame.height) - 2
                ...
                collectionViewConstraintHeight.constant = max(self.frame.height - imageCropViewOriginalConstraintTop - imageCropViewContainer.frame.height, self.frame.height - imageCropViewConstraintTop.constant - imageCropViewContainer.frame.height) - 2
            ...
            if currentPos.y < cropBottomY - dragDiff && imageCropViewConstraintTop.constant != imageCropViewOriginalConstraintTop {
                ...
                collectionViewConstraintHeight.constant = self.frame.height - imageCropViewMinimalVisibleHeight - 2
                ...
                collectionViewConstraintHeight.constant = self.frame.height - imageCropViewOriginalConstraintTop - imageCropViewContainer.frame.height - 2
